...
class App(customtkinter.CTk):
    ...
    def mainButtons(self):
        ...
        for i in range(len(ary)):
            locals()[i] = customtkinter.CTkButton(self.sidebar_frame, command=ary[i]['command'])
    ...
    def saveSettingOptionToFileFunc(self):
        ...
        for tab in ary :
            for labels in self.datas[tab] :
                self.datas[tab][labels]['value'] = globals()[f'__ui_labelsData_{labels}'].get()
        ...
        verifySettingList = [
            ...
            },
            {
                ...
                'bool':pathCheckChrome(self.datas[self.tabName_setting]['chromePath']['value'])
            },
            {
                'title':'sender',
